...
import com.example.android.neighbourhood.databinding.ImageMessageBinding
import com.example.android.neighbourhood.databinding.MessageBinding
...
class FriendAdapter(
    ...
    inner class MessageViewHolder(private val binding: MessageBinding) : ViewHolder(binding.root) {
        fun bind(item: FriendlyMessage) {
            ...
            setTextColor(item.email, binding.messageTextView)
        ...
        private fun setTextColor(userEmail: String?, textView: TextView) {
            Log.d("Adapter", "Current: ${currentUserEmail}, User: $userEmail")
            if (currentUserEmail == userEmail && userEmail != null) {
